      ...
      >
        ...
        <div style={{ marginBottom: 20, padding: 16, backgroundColor: '#1a1611', borderRadius: 8, border: '1px solid #3a3429' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, fontSize: 23 }}>
            <div>
              <div style={{ color: '#d4a84b', fontSize: 15, marginBottom: 4 }}>Remaining Quantity</div>
              <div style={{ color: '#f5ead6', fontSize: 23, fontWeight: 600 }}>{remainingQty.toLocaleString()}</div>
            </div>
            <div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ marginTop: 8, display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              />
              <label htmlFor="isNetPrice" style={{ color: '#f5ead6', fontSize: 20, cursor: 'pointer' }}>
